package org.bsdevelopment.text;
...
public class MessageConsole {
    ...
    public static void logOutput(OutputStream defaultOut, OutputStream defaultError) {
        try {
            final OutputStream logOutput = new BufferedOutputStream(new FileOutputStream(Bootstrap.LOG_FILE));
            ...
            AppConfig.sendAppMessage(() -> System.err.println(" Failed to create log file: " + Bootstrap.LOG_FILE.getName()));
        }
    }
    ...
    class ConsoleOutputStream extends ByteArrayOutputStream {
        ...
        private void clearBuffer() {
            ...
            } else if (AppConfig.isAppSpecificMessage()) {
                color = new Color(39, 136, 156);
            }

            if (line.startsWith("[ServerMaster]") || line.startsWith("[SM]")) color = Color.green;
